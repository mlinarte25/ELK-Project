...
Load balancing ensures that the application will be highly _secure defending organizations against distributed DDoS attacks, in addition to restricting _traffic to the network.
