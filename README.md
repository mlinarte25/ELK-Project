...
Load balancing ensures that the application will be highly _secure defending organizations against distributed DDoS attacks____, in addition to restricting _traffic____ to the network.
